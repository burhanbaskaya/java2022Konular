...
public class C01_Arrays {
    public static void main(String[] args) {
        ...
        // kullanmadan once mutlaka deger atamasi yapmaniz gerekir

        // hem deklare edip hem de atama yapacaksam nasil yapabilirim?
        // 1- deklare edip esitligin sagina suslu parantez icine degerleri yazabilirim
